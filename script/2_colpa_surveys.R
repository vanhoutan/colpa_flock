...
survey <- subset(DF, select = c(SPECIES, TIMEad, DURATION_kg_hr)) # subset full dataset for only columns of interest
...
survey2$SPECIES <- factor(survey2$SPECIES, levels=c("GRMA", "YCPA", "BHPA", "BYMA", "WEPA", "OCPA", "DHPA", "MEPA", "SCMA", "WBPA", "DBPA", "RGMA", "CWPA"))
